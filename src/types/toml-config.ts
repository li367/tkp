...
/**
 * Complete TKP TOML configuration structure
 */
export interface TkpTomlConfig {
  version: string
  lastUpdated: string
 ...
 */
export type PartialTkpTomlConfig = Partial<TkpTomlConfig> & {
