...
describe('cCU Command - Edge Cases', () => {
  ...
  describe('edge cases', () => {
    ...
    it('should handle tkpConfig read errors', async () => {
      // Config read fails, but we catch it and use default
      vi.mocked(tkpConfig.readTkpConfigAsync)
    ...
    it('should handle undefined tkpConfig fields', async () => {
      vi.mocked(tkpConfig.readTkpConfigAsync).mockResolvedValue({
    ...
    it('should handle race condition in error handling', async () => {
      ...
      vi.mocked(tkpConfig.readTkpConfigAsync).mockImplementation(async () => {
        configCallCount++
