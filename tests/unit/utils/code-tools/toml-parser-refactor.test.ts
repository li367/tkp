...
describe('tOML Parser Refactor', () => {
  ...
  describe('parseCodexConfig with toml-edit', () => {
    ...
    it('should parse TOML with project sections correctly', async () => {
      ...
      const complexToml = `[projects."/Users/miaoda/Documents/code/tkp"]
trust_level = "trusted"
local_model = "wenwen"
...
requires_openai_auth = true`
      ...
      expect(result.otherConfig!.some(line => line.includes('projects."/Users/miaoda/Documents/code/tkp"'))).toBe(true)
    })
...
`
  ...
  describe('renderCodexConfig with toml-edit', () => {
    ...
    it('should place global model_provider BEFORE sections to avoid scope issues', async () => {
      ...
      expect(result).toContain('# --- model provider added by TKP ---')
