...
Thank you for your interest in contributing to TKP (Zero-Config Code Flow)! We welcome contributions from the community and are pleased to have you join us.
...
TKP is a CLI tool built with TypeScript that provides zero-configuration setup for Claude Code environments. Before contributing, please:

1. Read our [Code of Conduct](CODE_OF_CONDUCT.md)
2. Check existing [issues](https://github.com/UfoMiao/tkp/issues) and [pull requests](https://github.com/UfoMiao/tkp/pulls)
...
1. **TKP Version**: Run `npx tkp --version`
...
Use our [bug report template](https://github.com/UfoMiao/tkp/issues/new?template=bug_report.md).
...
Use our [feature request template](https://github.com/UfoMiao/tkp/issues/new?template=feature_request.md).
...
TKP supports bilingual functionality (English/Chinese):
...
Thank you for contributing to TKP! Your efforts help make Claude Code more accessible and powerful for developers worldwide.

For questions about contributing, please [open an issue](https://github.com/UfoMiao/tkp/issues/new) or start a [discussion](https://github.com/UfoMiao/tkp/discussions).
