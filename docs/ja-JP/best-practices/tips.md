...
TKP を日常的に活用するための実用的なコツとベストプラクティスをまとめました。さまざまなシーンで効率良く TKP を使うためのリファレンスとして利用してください。

## 基本のヒント

### 1. まずはインタラクティブメニューに慣れる

**ポイント**：`npx tkp` から始める習慣を付けましょう。すべての機能に番号付きの案内があり、細かなパラメータを覚える必要がありません。
