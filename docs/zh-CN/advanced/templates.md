...
TKP 提供了完整的模板系统，包括工作流模板、输出风格模板和系统提示模板。这些模板支持多语言（中文和英文），可以自定义以满足团队特定需求。
...
| 方式 | 命令 | 说明 |
|------|------|------|
| **完整更新** | `npx tkp update` | 更新所有模板 |
| **仅更新文档** | `npx tkp init --config-action docs-only` | 仅更新提示词和文档 |
| **合并更新** | `npx tkp init --config-action merge` | 合并新模板到现有配置 |
