...
本文档收录了 TKP 使用过程中的常见问题和解决方案，帮助您快速定位和解决问题。
...
# 重新输入正确的密钥
npx tkp init -s -p 302ai -k "正确的密钥"
```
...
# 4. 检查命令前缀
# Claude Code: /tkp:workflow 或 /workflow
...
# 2. 确保 managed = true（TKP 管理的配置）
# 如果 managed = false，TKP 不会修改配置
