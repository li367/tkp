...
```
/tkp:feat <feature description>
```

**Example**:
```
/tkp:feat Implement user comment functionality, supporting likes, replies, and deletion
```
...
```
/tkp:feat Add shopping cart functionality, supporting multiple products, quantity modification, and batch checkout
```
...
```
/tkp:feat Enhance user profile center, add data statistics and activity history display
```
...
```
/tkp:feat Implement order system, supporting multiple payment methods, coupons, and logistics tracking
```
...
```
# Good description
/tkp:feat Implement user comment functionality, supporting text, images, likes, replies, deletion, administrators can review and delete any comment

# Not clear enough
/tkp:feat Comment functionality
```
...
/tkp:feat Implement user comment functionality

# 2. Based on planning results, use six-stage workflow to implement
/tkp:workflow Implement comment data model and API interface

# 3. Continue implementing other tasks
/tkp:workflow Implement comment frontend component and interaction
...
/tkp:feat Implement comment reply functionality, supporting nested replies and @ mentions

# Round 3: Optimization and enhancement
/tkp:feat Optimize comment performance, support pagination loading and real-time updates
```
...
|--------|---------|------|
| **Feature Development Workflow** (`/tkp:feat`) | New feature planning | Requirements analysis, solution design, UI/UX planning |
| **Six-Stage Workflow** (`/tkp:workflow`) | Specific implementation | Complete development process, from research to review |
| **BMad Workflow** (`/tkp:bmad-init`) | Enterprise-level projects | Complete team collaboration and iteration management |
...
- [Six-Stage Workflow](tkp-workflow.md) - Complete development process
