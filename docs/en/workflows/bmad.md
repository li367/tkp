...
After executing `/tkp:bmad-init`, TKP will:
...
### 5. Combine with Other TKP Workflows

BMad can be combined with other TKP workflows:
...
/tkp:feat Add comment functionality
...
If `/tkp:bmad-init` execution fails:
...
- **TKP Workflows**: [Workflow System](../features/workflows.md)
...
> 💡 **Tip**: BMad workflow is an important part of TKP workflow ecosystem, particularly suitable for standardized development of enterprise-level projects. It's recommended to introduce BMad workflow early in the project to gain maximum benefits. Combined with other TKP workflows and tools, you can build a complete AI-driven development process.
