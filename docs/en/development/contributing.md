...
Welcome contributors to the TKP project! This document will guide you on how to participate in project development, submit code, and contribute documentation.
...
3. Select `UfoMiao/tkp:main` as target branch
...
TKP follows [Conventional Commits](https://www.conventionalcommits.org/) standards.
