...
TKP adopts **Test-Driven Development (TDD)** methodology, requiring all new features to write tests first, ensuring code quality and maintainability. This document details testing strategies, writing standards, and best practices.
