...
This chapter introduces how to initialize your environment with TKP in minutes, covering pre-installation preparation, common commands, and recommended operation sequence.

## Quick Navigation

If you're new to TKP, we recommend following these steps:
...
1. Run `npx tkp` or `npx tkp init` for complete initialization
...
- Run `npx tkp update` to update workflows and templates
- Use `npx tkp` to open interactive menu for incremental configuration
- Use `npx tkp config-switch` to switch between different configurations
