...
TKP integrates environment configuration, workflow import, and toolchain into one CLI. Core capabilities can be divided into the following dimensions:
...
- **Command Line Tools**: Provides `tkp init/update/ccr/ccu/uninstall/config-switch` commands and aggregates them in an interactive menu.
